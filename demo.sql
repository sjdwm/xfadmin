...
--
-- Host: localhost    Database: xfadmin
-- ------------------------------------------------------
...
--
-- Table structure for table `xf_article`
--
...
--
-- Dumping data for table `xf_article`
--

LOCK TABLES `xf_article` WRITE;
/*!40000 ALTER TABLE `xf_article` DISABLE KEYS */;
/*!40000 ALTER TABLE `xf_article` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_auth_group`
--
...
--
-- Dumping data for table `xf_auth_group_access`
--

LOCK TABLES `xf_auth_group_access` WRITE;
/*!40000 ALTER TABLE `xf_auth_group_access` DISABLE KEYS */;
INSERT INTO `xf_auth_group_access` VALUES (1,1);
/*!40000 ALTER TABLE `xf_auth_group_access` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_auth_rule`
--
...
--
-- Table structure for table `xf_devlog`
--
...
--
-- Dumping data for table `xf_devlog`
--

LOCK TABLES `xf_devlog` WRITE;
/*!40000 ALTER TABLE `xf_devlog` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xf_devlog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_flash`
--
...
--
-- Dumping data for table `xf_flash`
--

LOCK TABLES `xf_flash` WRITE;
/*!40000 ALTER TABLE `xf_flash` DISABLE KEYS */;
/*!40000 ALTER TABLE `xf_flash` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_links`
--
...
--
-- Table structure for table `xf_log`
--
...
--
-- Dumping data for table `xf_log`
--

LOCK TABLES `xf_log` WRITE;
/*!40000 ALTER TABLE `xf_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `xf_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_member`
--
...
--
-- Dumping data for table `xf_member`
--

LOCK TABLES `xf_member` WRITE;
/*!40000 ALTER TABLE `xf_member` DISABLE KEYS */;
INSERT INTO `xf_member` VALUES (1,'admin','/Public/attached/201601/1453389194.png',1,1420128000,'13800138000','331349451','admin@hotxf.com','66d6a1c8748025462128dc75bf5ae8d1',1442505600);

/*!40000 ALTER TABLE `xf_member` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xf_setting`
--
...
--
-- Dumping data for table `xf_setting`
--

LOCK TABLES `xf_setting` WRITE;
/*!40000 ALTER TABLE `xf_setting` DISABLE KEYS */;
INSERT INTO `xf_setting` VALUES ('sitename','小风博客',0,''),('title','小风博客',0,''),('keywords','关键词',0,''),('description','网站描述',0,''),('footer','2017©小风网络',0,''),('test','测试',1,'测试变量');
/*!40000 ALTER TABLE `xf_setting` ENABLE KEYS */;
UNLOCK TABLES;
